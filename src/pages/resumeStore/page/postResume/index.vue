    ...
    <div class="TabView">
      <div class="createOrder">
        ...
        <div class="CreateContent">
          ...
          <el-form :model="form1" :rules="rules" ref="form1" class="demo-ruleForm" v-if="isEditForm1">
          ...
          <div class="infoCont" v-else>
            <div class="line_blo">
              ...
              <div class="row_blo">
                ...
                <img class="row_img" :src="editMsg.avatar.middleUrl">
              </div>
            </div>
            ...
            <div class="line_blo">
              <div class="row_blo">
                ...
                <div class="label_value">{{time(editMsg.birth)}}</div>          
              </div>
              <div class="row_blo">
                <span class="label_name">参加工作时间:</span>
                <div class="label_value">{{time(editMsg.startWorkYear)}}</div>              
              </div>
            </div>
            <div class="line_blo">
              <div class="row_blo">
                <span class="label_name">求职状态:</span>
                <div class="label_value">{{editMsg.jobStatus | getJobStatus}}</div>              
              </div>
          ...
          <el-form :model="form3" :rules="rules" ref="form3" class="demo-ruleForm" v-if="isEditForm3">
            ...
            <el-form-item label-width="80px" label="期望领域" class="formItem" prop="fieldIds">
              <el-select multiple collapse-tags v-model="form3.fieldIds" placeholder="请选择">
                <el-option
          ...
          <div class="infoCont" v-for="item,index in editMsg.expects" v-else>
            ...
            <div class="line_blo">
              <div class="row_blo">
                ...
                <div class="label_value">{{item.salaryFloor}}k-{{item.salaryCeil}}k</div>   
              </div>
              <div class="row_blo">
          ...
          <el-form :model="form4" :rules="rules" ref="form4" class="demo-ruleForm" v-if="isEditForm4">
          ...
          <div class="infoCont" v-else>
            <div class="line_blo">
              <div class="row_blo">
                ...
                <div class="label_value">{{editMsg.moreIntroduce.introduce}}</div>
              </div>            
            </div>
            <div class="line_blo">
              <div class="row_blo">
          ...
          <h4 class="classifyTitle">上传附件</h4>
          <el-form :model="form8" :rules="rules" ref="form8" class="demo-ruleForm">
