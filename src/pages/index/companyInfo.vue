...
<template>
  ...
  <div class="createCompany">
    ...
    <div class="companyInfo" v-if="active === 0">
      ...
      <el-form class="edit-form" ref="companyInfo" :model="companyInfo" label-width="150px" label-suffix="：">
        <h3>公司信息</h3>
        <!--工牌/名片/在职证明-->
        ...
        <!--工牌/名片/在职证明-->
        <el-form-item class="full" label="工牌/名片/在职证明(三选一)" prop="icon" v-if="companyInfo.businessLicenseInfo">
